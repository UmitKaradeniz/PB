...
export default defineComponent({
  ...
  data() {
    return {
      ...
      class_val1: "shadow-1 my-card",
      class_val2: "shadow-1 my-card",
      class_val3: "shadow-1 my-card",
      class_val4: "shadow-1 my-card",
      class_val5: "shadow-1 my-card",
      class_val6: "shadow-1 my-card",
    };
  },
